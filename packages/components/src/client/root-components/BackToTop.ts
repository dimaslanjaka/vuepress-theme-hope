...
import { Transition, computed, defineComponent, h, onBeforeUnmount, onMounted, ref } from 'vue';
...
export default defineComponent({
    ...
    setup(props) {
        ...
        const show = computed<boolean>(() => {
            ...
            return (pageEnable || (globalEnable && pageEnable !== false)) && scrollTop.value > thresholdDistance.value;
        });
