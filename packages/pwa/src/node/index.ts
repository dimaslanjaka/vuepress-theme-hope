...
const pwaPlugin: Plugin<PWAOptions> = (options, app) => {
    ...
    const pwaOption = Object.keys(options).length > 0 ? options : (themeConfig.pwa as PWAOptions) || {};
    ...
    const config: PluginObject = {
        ...
        clientAppRootComponentFiles: [
            pwaOption.popupComponent || path.resolve(__dirname, '../client/global-components/SWUpdatePopup.js'),
        ],
