<template>
    <div id="install-modal-wrapper">
        ...
        <div class="install-modal">
            <div class="header">
                <button class="close-button" :aria-label="i18n.close" @click="$emit('toggle', false)">
                    <CloseIcon />
                </button>
                <div class="logo">
                    <img v-if="manifest.icons" :src="manifest.icons[0].src" alt="App Logo" />
                    <div class="title">
                ...
                <div class="highlight">
                    <div v-if="manifest.features" class="feature-wrapper">
                        ...
                        <ul v-if="manifest.features">
                            <li v-for="feature in manifest.features" :key="feature" v-text="feature" />
                        </ul>
                    </div>
                    ...
                    <div v-if="manifest.screenshots" class="screenshot-wrapper">
                        ...
                        <section class="screenshot">
                            <div v-for="screenshot in manifest.screenshots" :key="screenshot.src">
...
export default defineComponent({
    ...
    setup(_props, { emit }) {
        ...
        const getManifest = async (): Promise<void> => {
            ...
            if (manifestContent) manifest.value = JSON.parse(manifestContent) as ManifestOption;
            else
                try {
