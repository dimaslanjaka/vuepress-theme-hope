...
export const wait = (message: string): void => console.log(blue('Feed:'), black.bgYellowBright('wait'), message);

export const warn = (message: string): void => console.log(blue('Feed:'), black.bgYellow('warn'), message);

export const error = (message: string): void => console.log(blue('Feed:'), black.bgRed('Error'), message);

export const success = (message: string): void => console.log(blue('Feed:'), black.bgGreen('Success'), message);
...
export const getImageMineType = (ext = ''): string =>
    `image/${
        ext === 'jpg'
            ...
            : ext === 'svg'
            ? 'svg+xml'
            : ext === 'jpeg' || ext === 'png' || ext === 'bmp' || ext === 'gif' || ext === 'webp'
            ? ext
            : ''
    }`;
 ...
 */
export const encodeCDATA = (content: string): string => content.replace(/]]>/g, ']]]]><![CDATA[>');
