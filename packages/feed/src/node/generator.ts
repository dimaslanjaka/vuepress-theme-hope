...
export class FeedGenerator {
    ...
    constructor(private pages: Page[], private options: FeedOptions, feedOption: FeedInitOptions, private app: App) {
    ...
    addPages(): void {
        ...
        for (const page of pages) {
            const item = new FeedPage(page, this.feed, this.options, this.app).getFeedItem();
    ...
    async generateFeed(): Promise<void> {
        ...
        if (output.atom.enable) {
            ...
            success(`Atom feed file generated and saved to ${cyan(relative(__dirname, filePath))}`);
        }
        ...
        if (output.json.enable) {
            ...
            success(`JSON feed file generated and saved to ${cyan(relative(__dirname, filePath))}`);
        }
        ...
        if (output.rss.enable) {
            ...
            success(`RSS feed file generated and saved to ${cyan(relative(__dirname, filePath))}`);
        }
    }
}
