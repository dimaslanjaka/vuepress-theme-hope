...
export interface SeoOptions {
    ...
    seo?: <PageExtends = Record<string, unknown>>(info: PageSeoInfo<PageExtends>) => Partial<SeoContent>;

    /** Function to custom head */
    customHead?: <PageExtends = Record<string, unknown>>(head: HeadConfig[], info: PageSeoInfo<PageExtends>) => void;
}
