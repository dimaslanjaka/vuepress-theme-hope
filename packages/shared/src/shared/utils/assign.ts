...
export const deepAssign = <T extends IAnyObject, U extends IAnyObject = T, V extends IAnyObject = T>(
    originObject: T,
    ...assignObjects: U[]
): V => {
...
export const deepAssignReverse = (...assignObjects: IAnyObject[]): IAnyObject => {
