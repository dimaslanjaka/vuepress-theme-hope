declare module '@waline/client' {
    ...
    export type Avatar = '' | 'mp' | 'identicon' | 'monsterid' | 'wavatar' | 'retro' | 'robohash' | 'hide';
    ...
    export interface WalineOption {
        ...
        placeholder?: string;
        /**
         * @deprecated Use `copyright` instead, will be dropped in V1
         */
        copyRight?: boolean;
