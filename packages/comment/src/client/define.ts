import type { CommentOptions, PageInfoI18nConfig, WalineOptions } from '../shared';
...
export const enableWaline = Boolean(walineOption && walineOption.type === 'waline' && walineOption.serverURL);
