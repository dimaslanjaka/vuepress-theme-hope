<template>
    <svg class="icon icon-flipboard" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M453.922 452.523h160.343v160.343H453.922V452.523z" fill="#F6BEBE" />
    </svg>
</template>
