...
import { footnote, katex, mark, mermaid, presentation, sub, sup, tasklist } from './markdown-it';
...
const markdownEnhancePlugin: Plugin<MarkdownEnhanceOptions> = (option, app) => {
    ...
    const markdownOption =
        Object.keys(option).length === 0 ? (themeConfig.mdEnhance as MarkdownEnhanceOptions) || {} : option;
    ...
    const revealPlugins =
        typeof markdownOption.presentation === 'object' && Array.isArray(markdownOption.presentation.plugins)
    ...
    return {
        ...
        define: (): Record<string, unknown> => ({
            ...
            CODE_DEMO_OPTIONS: {
                ...
                ...(typeof markdownOption.demo === 'boolean' ? {} : markdownOption.demo),
            },
            MERMAID_OPTIONS: typeof markdownOption.mermaid === 'object' ? markdownOption.mermaid : {},
            REVEAL_CONFIG:
        ...
        extendsMarkdown: (markdownIt): void => {
            ...
            if (tasklistEnable)
                markdownIt.use(tasklist, [typeof markdownOption.tasklist === 'object' ? markdownOption.tasklist : {}]);
