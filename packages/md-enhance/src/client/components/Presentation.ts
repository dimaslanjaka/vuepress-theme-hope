    ...
    setup(props) {
        ...
        onMounted(() => {
            if (presentationElement.value) {
                code.value = decodeURIComponent(presentationContainer.value?.dataset.code || '');
                ...
                promises.push(import(/* webpackChunkName: "reveal" */ 'reveal.js/plugin/markdown/markdown.esm.js'));

                if (REVEAL_PLUGIN_HIGHLIGHT)
                    promises.push(
                        import(/* webpackChunkName: "reveal" */ 'reveal.js/plugin/highlight/highlight.esm.js')
                    );

                if (REVEAL_PLUGIN_MATH)
                    promises.push(import(/* webpackChunkName: "reveal" */ 'reveal.js/plugin/math/math.esm.js'));

                if (REVEAL_PLUGIN_SEARCH)
                    promises.push(import(/* webpackChunkName: "reveal" */ 'reveal.js/plugin/search/search.esm.js'));

                if (REVEAL_PLUGIN_NOTES)
                    promises.push(import(/* webpackChunkName: "reveal" */ 'reveal.js/plugin/notes/notes.esm.js'));

                if (REVEAL_PLUGIN_ZOOM)
                    promises.push(import(/* webpackChunkName: "reveal" */ 'reveal.js/plugin/zoom/zoom.esm.js'));
                ...
                void Promise.all(promises).then(([revealJS, ...plugins]) => {
                    const reveal = new revealJS.default(presentationElement.value as HTMLElement, {
