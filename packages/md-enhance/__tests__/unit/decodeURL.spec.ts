...
import { decodeURL } from '../../src/node/markdown-it/';
...
describe('decode-url', () => {
    it('Should resolve all', () => {
        ...
        expect(markdownIt.render('![image.png](http://a.b.c/图片/image.png)')).toEqual(
            '<p><img src="http://a.b.c/图片/image.png" alt="image.png" /></p>\n'
        );

        expect(markdownIt.render('![image.png](https://a.b.c/图片/image.png)')).toEqual(
