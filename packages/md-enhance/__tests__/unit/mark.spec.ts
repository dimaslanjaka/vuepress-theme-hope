...
describe('mark', () => {
    ...
    it('Can nested', () => {
        expect(markdownIt.render(`x ====foo== bar==`)).toEqual('<p>x <mark><mark>foo</mark> bar</mark></p>\n');
        expect(markdownIt.render(`x ==foo ==bar====`)).toEqual('<p>x <mark>foo <mark>bar</mark></mark></p>\n');
        expect(markdownIt.render(`x ====foo====`)).toEqual('<p>x <mark><mark>foo</mark></mark></p>\n');
        expect(markdownIt.render(`==foo ==bar== baz==`)).toEqual('<p><mark>foo <mark>bar</mark> baz</mark></p>\n');
